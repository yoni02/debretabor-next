...
const FAQS = [
  { q: 'What time are services?', a: 'Divine Liturgy is every Sunday from 7:00 AM to 9:30 AM. Covenant Prayer begins at 6:30 AM. Check our Services page for the full schedule including Sunday School and other programs.' },
