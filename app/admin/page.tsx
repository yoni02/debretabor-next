...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      <h1 style={{ fontSize: '1.8rem', color: '#b8860b', marginBottom: '0.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
        <Link href="/admin/events" style={{ textDecoration: 'none' }}>
          <div style={{ background: 'rgba(255,252,248,0.95)', border: '1px solid rgba(184,168,138,0.35)', borderRadius: 20, padding: '2rem', textAlign: 'center', boxShadow: '0 2px 12px rgba(61,53,41,0.06)' }}>
